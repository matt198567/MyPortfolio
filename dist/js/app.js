...
***************************************************************************** */
    ...
    const translations = {
        ...
        uk: {
            ...
            "main.value": "Анастасія",
            "main.big": "Биковська",
            "main.text": "Я фронтенд-розробниця з трирічним досвідом роботи над фриланс-проєктами. Спеціалізуюсь на створенні адаптивних, швидких та зручних інтерфейсів, які поєднують сучасний дизайн і чистий, підтримуваний код. За час своєї роботи успішно реалізувала понад 30 проєктів для клієнтів з різних країн, включаючи лендінги та багатосторінкові сайти.",
            ...
            "skills.text": "Процес навчання зайняв більше року. Протягом цього періоду я постійно вивчала фронтенд і експериментувала з новими технологіями та фреймворками, а підсумок моїх навичок ви можете побачити тут.",
        ...
        ru: {
            ...
            "main.value": "Анастасия",
            "main.big": "Быковская",
            "main.text": "Я фронтенд-разработчик с трехлетним опытом работы над фриланс-проектами. Специализируюсь на создании адаптивных, быстрых и удобных интерфейсов, сочетающих современный дизайн и чистый, поддерживаемый код. За время своей работы успешно реализовала более 30 проектов для клиентов из разных стран, включая лендинги и многостраничные сайты.",
